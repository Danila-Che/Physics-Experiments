...
namespace XPBD
{
    internal class FakeJoint
    {
        ...
        public FakeJoint(FakeBody body0, FakeBody body1, FakeJointParams parameters)
        {
            ...
            m_LocalPose0 = new FakePose(m_Params.LocalPos0, m_Params.LocalRot0);
            m_LocalPose1 = new FakePose(m_Params.LocalPos1, m_Params.LocalRot1);
        ...
        public void SolvePos(float deltaTime)
        {
            UpdateGlobalPoses();
        ...
        public void SolveVel(float deltaTime)
        {
